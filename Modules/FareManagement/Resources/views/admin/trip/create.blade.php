                            ...
                            @forelse($vehicleCategories as $vehicleCategory)
                                ...
                                <label class="custom-checkbox">
                                    <input type="checkbox" class="test"
                                           name="vehicle_category_{{$vehicleCategory->id}}"
                                           value="{{$vehicleCategory->id}}"
                                           @if($trip?->vehicle_category_id == $vehicleCategory->id)
                                               checked
                                        @endif
                                    >
                        ...
                        <div class="row gy-4 custom-class-fare mt-3">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="input-group_tooltip">
                                    <input type="number" class="form-control part-1-input copy-value" step=".01" min="0.01" name="base_fare" id="base_fare"
                                        placeholder="{{ translate('Base_Fare') }}" value="{{ $defaultTripFare->base_fare ?? 0 }}" required>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="input-group_tooltip">
                                    <input type="number" class="form-control part-1-input copy-value" step=".01" min="0.01"
                                           name="base_fare_per_km" placeholder="{{ translate('Fare_(Per_km)')}}"
                                           id="base_fare_per_km" value="{{$defaultTripFare->base_fare_per_km ?? 0}}"
                                           required>
                                    <i class="bi bi-info-circle-fill text-primary tooltip-icon" data-bs-toggle="tooltip"
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <label for="cancellation_fee" class="form-label">{{ translate('Cancellation_Fee_(%)') }}</label>
                                <div class="input-group_tooltip">
                                    <input type="number" name="cancellation_fee" min="0" max="100" step=".01"
                                           class="form-control part-1-input copy-value"
                                           placeholder="{{ translate('Cancellation_Fee_(%)')}}"
                                           id="cancellation_fee"
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="input-group_tooltip">
                                    ...
                                    <i class="bi bi-info-circle-fill text-primary tooltip-icon" data-bs-toggle="tooltip"
                                       data-bs-title="{{ translate('set_the_minimum_cancellation_fee_for_the_users_to_cancel_the_trip') }}"
                                    ></i>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="input-group_tooltip">
                                    ...
                                    <i class="bi bi-info-circle-fill text-primary tooltip-icon" data-bs-toggle="tooltip"
                                       data-bs-title="{{ translate('set_the_fee_(per_min_)_for_the_customer_when_he/she_requests_to_wait_the_driver_on_an_ongoing_trip') }}"
                                    ></i>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-4">
                                <label for="trip_delay_fee" class="form-label">{{ translate('Trip_Delay_Fee_(Per_min)') }}</label>
                                <div class="input-group_tooltip">
                                    <input type="number" name="trip_delay_fee" step=".01"
                                           class="form-control part-1-input copy-value"
                                           placeholder="{{ translate('Trip_Delay_Fee_(Per_min)')}}"
                                           id="trip_delay_fee" value="{{$defaultTripFare->trip_delay_fee_per_min ?? 0}}"
                                           required>
                                    <i class="bi bi-info-circle-fill text-primary tooltip-icon" data-bs-toggle="tooltip"
                                       data-bs-title="{{ translate('set_the_fee_(per_min)_for_the_customer_when_the_trip_took_longer_than_the_estimated_time') }}"
                                    ></i>
                                </div>
                            </div>
                                    ...
                                    <table class="table align-middle table-borderless table-variation">
                                        ...
                                        <tr>
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <th class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">{{$vehicleCategory->name}}</th>
                                            @empty
                                            @endforelse
                                        </tr>
                                        </thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input disabled type="number"
                                                       class="form-control base_fare_default"
                                                       value="{{$defaultTripFare->base_fare ?? 0}}" required>
                                            </td>
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                @php( $trip = $tripFares?->firstWhere('vehicle_category_id', $vehicleCategory->id) )
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0.01"
                                                           ...
                                                           value="{{ $trip?->base_fare ? round($trip->base_fare, 2) : 0 }}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'disabled'  }} required>
                                                </td>
                                            @empty
                                            @endforelse
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0.01"
                                                           ...
                                                           value="{{$trip?->base_fare_per_km ? round($trip->base_fare_per_km , 2) :  0}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'disabled'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0" max="100"
                                                           ...
                                                           class="form-control cancellation_fee_default part-2-input {{$vehicleCategory->id}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'disabled'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                        </tr>
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0"
                                                           ...
                                                           class="form-control min_cancellation_fee_default part-2-input {{$vehicleCategory->id}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'disabled'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                        </tr>
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0"
                                                           ...
                                                           class="form-control idle_fee_default part-2-input {{$vehicleCategory->id}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'disabled'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                        </tr>
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0"
                                                           ...
                                                           class="form-control trip_delay_fee_default part-2-input {{$vehicleCategory->id}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'disabled'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                        </tr>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!part1Filled && !part2Filled) {
                    event.preventDefault();
                    toastr.error('{{translate('please_enter_vehicle_wise_or_category_wise_information')}}')
                }
            });
        });
