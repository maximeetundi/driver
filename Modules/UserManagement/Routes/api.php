...
//            Route::get('leaderboard', [\Modules\UserManagement\Http\Controllers\Api\Driver\ActivityController::class, 'leaderboard']);
//            Route::get('daily-income', [\Modules\UserManagement\Http\Controllers\Api\Driver\ActivityController::class, 'dailyIncome']);
