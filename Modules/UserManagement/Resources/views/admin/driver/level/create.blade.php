                                    ...
                                    <div id="rewardAmountDiv" class="col-sm-6 d-none">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" step=".01" name="reward_amount"
                                                   ...
                                                   id="rewardAmount" class="form-control" placeholder="{{ translate('ex') }}: {{ 500 }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" required name="targeted_ride" value="{{old('targeted_ride')}}"
                                           id="min_ride_complete" class="form-control" placeholder="{{ translate('ex') }}: {{ 50 }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" required name="targeted_cancel"
                                           ...
                                           class="form-control" placeholder="{{ translate('ex') }}: {{ 50 }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
