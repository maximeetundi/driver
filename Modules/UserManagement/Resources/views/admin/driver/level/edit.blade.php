                                ...
                                <div class="row align-items-end">
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" disabled class="form-control"
                                                value="{{ $level->sequence }}" placeholder="{{ translate('ex') }}:  2 ">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                            ...
                                            <select class="js-select" disabled id="rewardType">
                                                <option value="no_rewards"
                                                    {{ $level->reward_type == 'no_rewards' ? 'selected' : '' }}>
                                                    {{ translate('no_rewards') }}</option>
                                                <option value="wallet"
                                                    {{ $level->reward_type == 'wallet' ? 'selected' : '' }}>
                                                    {{ translate('wallet') }}</option>
                                                <option value="loyalty_points"
                                                    {{ $level->reward_type == 'loyalty_points' ? 'selected' : '' }}>
                                                    {{ translate('loyalty_points') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6" id="rewardAmountDiv">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" disabled name=""
                                                value="{{ $level->reward_amount }}" id="rewardAmount" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_ride" value="{{ $level->targeted_ride }}"
                                        id="min_ride_complete" class="form-control" placeholder="{{ translate('ex') }}: {{ 50 }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    <label for="points" class="mb-2">{{ translate('points') }}</label>
                                    <input type="number" name="targeted_ride_point"
                                        value="{{ $level->targeted_ride_point }}" id="points" class="form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" step=".01" name="targeted_amount"
                                        value="{{ $level->targeted_amount }}" id="min_earn_amount" class="form-control"
                                        placeholder="{{ translate('ex') }}: {{ 5000 }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    <label for="points2" class="mb-2">{{ translate('points') }}</label>
                                    <input type="number" name="targeted_amount_point"
                                        value="{{ $level->targeted_amount_point }}" id="points2" class="form-control"
                                        placeholder="{{ translate('ex') }}: {{ 900 }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_cancel" value="{{ $level->targeted_cancel }}"
                                        id="max_cancellation_rate" class="form-control" placeholder="{{ translate('ex') }}: {{ 50 }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_cancel_point"
                                        value="{{ $level->targeted_cancel_point }}" id="points3" class="form-control"
                                        placeholder="{{ translate('ex') }}: {{ 300 }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_review" step=".01"
                                        value="{{ $level->targeted_review }}" id="min_give_review" class="form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_review_point"
                                        value="{{ $level->targeted_review_point }}" id="points4" class="form-control"
                                        placeholder="Ex: 800" required>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            if (value !== 'no_rewards') {
                if (value == 'wallet') {
                    $('#rewardAmountLabel').text(
                        '{{ translate('reward_amount') }} ({{ session()->get('currency_symbol') ?? '$' }})')
                } else {
