<div class="row justify-content-center g-3">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-end justify-content-between gap-3 mb-4">
                    ...
                    <h3 class="fs-21 text-primary">{{$registered}}</h3>
                </div>
    ...
    <div class="col-lg-4 col-md-4 col-6">
        <div class="card analytical_data analytical_data-color6">
            <div class="card-body">
                <div class="d-flex align-items-end justify-content-between gap-3 mb-4">
                    <div class="analytical_data-icon mb-0 rounded">
                        <img src="{{asset('public/assets/admin-module/img/svg/active_customer.svg')}}" class="svg" alt="">
                    </div>
                    <h3 class="fs-21 text-primary">{{$verified}}</h3>
                </div>
                <div class="text-muted mb-1">{{translate('total')}}</div>
                <h6 class="fw-semibold text-capitalize">{{translate('regular_customer')}}</h6>
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-md-4 col-6">
        <div class="card analytical_data analytical_data-color4">
            <div class="card-body">
                <div class="d-flex align-items-end justify-content-between gap-3 mb-4">
                    ...
                    <h3 class="fs-21 text-primary">{{$new}}</h3>
                </div>
                <div class="text-muted mb-1">{{translate('total')}}</div>
...
{{--                    </div>--}}
{{--                    <h3 class="fs-21 text-primary">{{$loyalCustomer}}</h3>--}}
{{--                </div>--}}
{{--                <div class="text-muted mb-1">{{translate('total')}}</div>--}}
{{--                <h6 class="fw-semibold text-capitalize">{{translate('loyal_customer')}}</h6>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--    <div class="col-lg-4 col-md-4 col-6">--}}
...
{{--                </div>--}}
{{--                <div class="text-muted mb-1">{{translate('total')}}</div>--}}
{{--                <h6 class="fw-semibold text-capitalize">{{translate('verified_customer')}}</h6>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
</div>
