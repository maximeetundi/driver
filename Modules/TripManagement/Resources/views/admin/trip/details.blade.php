                                        ...
                                        <div class="media align-items-center gap-3">
                                            ...
                                            <div class="media-body">
                                                <div class="d-flex flex-column align-items-start gap-1">
                                                    ...
                                                    <div class="badge bg-primary">{{ $trip->driver->level?->name }}</div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-center gap-2 h-100">
                                            <div class="d-flex flex-column align-items-center justify-content-center gap-2">
                                                <img src="{{ asset('public/assets/admin-module/img/svg/driver.svg') }}" class="" alt="" width="50">
                                 ...
                                 <div class="card">
                                     <div class="card-body">
                                         <div class="d-flex gap-1">
                                             <div>
                                                 <img src="{{asset('public/assets/admin-module/img/cancellation_reason.png')}}" alt="" width="20" height="20">
                                             </div>
                                             <div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="px-xl-3">
                                            <dl class="data-list gy-2 text-dark">
                                                ...
                                                @if ($trip->type != 'parcel')
                                                    ...
                                                    <dd class="m-0">+ {{ set_currency_symbol($trip?->fee?->delay_fee) }}</dd>
                                                    ...
                                                    <dd class="m-0">+ {{ set_currency_symbol($trip?->fee?->idle_fee) }}</dd>
                                                ...
                                                <dt class="text-capitalize">{{ translate('discount_amount') }}</dt>
                                                <dd class="m-0"> -{{ set_currency_symbol($trip->discount_amount + 0) }}</dd>
                                                <dt class="text-capitalize">{{ translate('coupon_discount') }}</dt>
                                                <dd class="m-0"> -{{ set_currency_symbol($trip->coupon_amount + 0) }}</dd>
                                                ...
                                                <dt>
                                                    {{ translate('VAT/Tax') }}
                                                    <small class="font-semi-bold"><strong>({{ round((($trip?->fee?->vat_tax ?? 0) * 100) / $totalAmount) }}%)</strong></small>
                                                </dt>
                                                <dd class="m-0">+ {{ set_currency_symbol($trip?->fee?->vat_tax + 0) }}</dd>

                                                @if ($trip->tips > 0)
                                                    <dt>{{ translate('tips') }}</dt>
                                        ...
                                        <div class="mt-4 d-flex justify-content-end gap-3">
                                            <a target="_blank" href="{{ route('admin.trip.invoice', [$trip->id]) }}?file=print"
                                                class="btn-link text-primary text-capitalize">
                                                <i class="bi bi-file-earmark-arrow-down"></i>
                                                {{ translate('print') }}
                                            </a>

                                            <a target="_blank" href="{{ route('admin.trip.invoice', [$trip->id]) }}?file=pdf"
                                               class="btn-link text-primary text-capitalize">
                                                <i class="bi bi-file-earmark-arrow-down"></i>
