        ...
        <div class="container">
            <div class="about__wrapper">
                ...
                <div class="bg-transparent about__wrapper-content wow animate__fadeInDown">
                    ...
                    <p>
                        {{ $earnMoney?->value && $earnMoney?->value['sub_title'] ? translate($earnMoney?->value['sub_title']) : translate("With flexible schedules and a user-friendly platform, you can earn money with every ride. Become a DriveMond today!") }}
                    </p>
                    <br>
